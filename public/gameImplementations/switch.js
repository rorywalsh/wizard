...
class Switch extends SheddingFamilyCardGame {
    ...
    static validateMove = function(discardPile, card) {
        ...
        if (card.suit === discardPile[lastCardIndex].suit) {
            ...
            return "Player has match number and switched suit";
            ...
            if (discardPile.length > 1 && discardPile[lastCardIndex - 1].number === 2)
                return "Player has played has played a 2 on a previous 2 - next player picks four";
            if (discardPile.length > 2 && discardPile[lastCardIndex - 1].number === 2 && discardPile[lastCardIndex - 2].number === 2)
                return "Player has played has played a 2 on a previous 2 on a previous 2 - next player picks 6";
